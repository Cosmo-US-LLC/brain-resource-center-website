...
const conditions = [
  ...
  },
  {
    ...
    description:
      "To calm an overactive stress response and manage constant worry or nervous tension.",
  },
  {
    id: 3,
    title: "Obsessive Compulsive Disorder (OCD)",
    description:
      "To help control intrusive thoughts and break the cycle of repetitive, uncontrollable behaviors.",
  },
  {
    id: 4,
    title: "Post-Traumatic Stress Disorder (PTSD)",
    description:
      "To alleviate heightened emotional reactions and reduce stress caused by traumatic experiences.",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    description:
      "To improve focus, reduce distractibility, and enhance impulse control.",
  },
  {
    id: 7,
    title: "Autism Spectrum Disorder (ASD)",
    description:
      "To support emotional regulation, cognitive flexibility, and sensory processing challenges.",
  },
  {
    id: 8,
    title: "Insomnia & Sleep Disorders",
    description:
      "To improve sleep quality by regulating the brain’s sleep-wake cycle.",
  },
  {
    id: 9,
    title: "Traumatic Brain Injury (TBI) / Concussion Recovery",
    description:
      "To aid in cognitive and emotional recovery after a head injury or concussion.",
  },
  {
    id: 10,
    title: "Cognitive Decline & Brain Fog",
    description:
      "To sharpen memory, improve processing speed, and boost mental clarity.",
  },
];
...
function WhoCanBenefit() {
  ...
  return (
    <section className="py-16 md:py-20 !bg-[#F1F8FF] ">
      ...
      >
        Who Can <br className="md:hidden" /> Benefit from{" "}
        <br className="md:hidden" /> rTMS Therapy?
      </h2>
      <div className="max-w-[1280px] border-2 border-[#F1F8FF] max-md:border-t-[#004F97] bg-white mx-auto py-8 px-6 md:rounded-[12px] ">
        <div className="  p-0 md:p-6">
          ...
          <div className="flex flex-col lg:flex-row gap-x-[16px]">
            <div className="flex-1 columns-1 md:columns-2 gap-[16px]">
              {conditions.map((condition) => {
                ...
                return (
                  <div
                    ...
                    key={condition.id}
                    className={`break-inside-avoid mb-[16px] rounded-[16px] py-[32px] px-4 transition-all duration-300 ${
                      isActive
                        ? "bg-[#004F97]"
                        : "bg-[#F1F8FF] max-h-[151px] flex items-center justify-between"
                    }`}
                  >
                    <div
                    ...
                    {isActive && (
                      <div className="mt-4 space-y-4">
                        ...
                        <Link
                          ...
                          style={{
                            fontFamily:
                              '"Inter", "Open Sauce Sans", sans-serif',
                            fontSize: "14px",
                            fontStyle: "normal",
                            fontWeight: 700,
                            lineHeight: "20px",
