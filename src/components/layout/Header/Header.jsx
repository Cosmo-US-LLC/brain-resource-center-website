      ...
      <div className="max-w-[1280px] px-4 md:px-8 mx-auto">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden gap-3 items-center lg:flex">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" className="transition-colors duration-200">
  <g clipPath="url(#clip0_1645_2214)">
    <path d="M2.68397 6.90575L4.66397 4.92575C4.86068 4.72575 4.99982 4.47641 5.06674 4.20398C5.13366 3.93156 5.12588 3.64613 5.04422 3.37775C4.90547 2.92122 4.78289 2.45994 4.67672 1.99475C4.58972 1.5875 4.23197 1.25 3.81497 1.25H2.68397C1.85147 1.25 1.16672 1.928 1.25822 2.756C1.95272 9.05 6.95072 14.0473 13.244 14.7418C14.072 14.8333 14.75 14.1493 14.75 13.3168V12.1843C14.75 11.7688 14.411 11.4267 14.0015 11.3517C13.5514 11.2642 13.107 11.1493 12.671 11.0075C12.0957 10.8245 11.4567 10.9535 11.03 11.3795L9.09422 13.316M8.74997 2C10.1424 2 11.4777 2.55312 12.4623 3.53769C13.4468 4.52226 14 5.85761 14 7.25M8.74997 5C9.34671 5 9.91901 5.23705 10.341 5.65901C10.7629 6.08097 11 6.65326 11 7.25" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </g>
  <defs>
    <clipPath id="clip0_1645_2214">
                ...
                >
                  <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                      <g clip-path="url(#clip0_1645_2214)">
                        <path d="M2.68397 6.90575L4.66397 4.92575C4.86068 4.72575 4.99982 4.47641 5.06674 4.20398C5.13366 3.93156 5.12588 3.64613 5.04422 3.37775C4.90547 2.92122 4.78289 2.45994 4.67672 1.99475C4.58972 1.5875 4.23197 1.25 3.81497 1.25H2.68397C1.85147 1.25 1.16672 1.928 1.25822 2.756C1.95272 9.05 6.95072 14.0473 13.244 14.7418C14.072 14.8333 14.75 14.1493 14.75 13.3168V12.1843C14.75 11.7688 14.411 11.4267 14.0015 11.3517C13.5514 11.2642 13.107 11.1493 12.671 11.0075C12.0957 10.8245 11.4567 10.9535 11.03 11.3795L9.09422 13.316M8.74997 2C10.1424 2 11.4777 2.55312 12.4623 3.53769C13.4468 4.52226 14 5.85761 14 7.25M8.74997 5C9.34671 5 9.91901 5.23705 10.341 5.65901C10.7629 6.08097 11 6.65326 11 7.25" stroke="#004F97" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                      </g>
                      <defs>
                        <clipPath id="clip0_1645_2214">
                          <rect width="16" height="16" fill="white" />
